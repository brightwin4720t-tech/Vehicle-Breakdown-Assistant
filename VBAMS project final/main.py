...
def send_user_notification(request: Request, complaint_id: int, username: str, user_phone: str, user_email: str, mechanic_name: str, mechanic_phone: str):
        ...
        if user_info and mech_info:
            try:
                send_user_notification(
                    ...
                    mechanic_name=mech_info['mechanicname'],
                    mechanic_phone=mech_info['mechanicphoneno']
                )
            except Exception as notification_error:
                print(f"Error in send_user_notification trigger: {notification_error}")
...
def handle_forgot_password(
    ...
    # 5. Send email (or log to terminal as fallback)
    smtp_host = os.getenv("SMTP_HOST", "")
    smtp_port = os.getenv("SMTP_PORT", "587")
    smtp_user = os.getenv("SMTP_USER", "")
    smtp_password = os.getenv("SMTP_PASSWORD", "")
